 ...
 * @author Caleb
 */
public class ElegirUnidadAgregarHorarioController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        textInicio.setOnMouseClicked((MouseEvent me) -> {
            Stage stageElegirUnidad = (Stage) (textInicio.getScene().getWindow());
            ...
            try {
                ...
                stageElegirUnidad.setScene(sceneInicioJefe);
    ...
    @FXML
    public void obtenerDatos(MouseEvent me){
        Materia materiax = tableviewUnidades.getSelectionModel().getSelectedItem();
        if(materiax != null){
            irAUnidadHorario(materiax);
        }
    }
    
    public void irAUnidadHorario(Materia materia){
        Stage stageElegirUnidad = (Stage) (textUnidades.getScene().getWindow());
        AgregarHorarioUnidadController agregarHorario = new AgregarHorarioUnidadController(materia);
        FXMLLoader horarioUnidad = new FXMLLoader(getClass().getResource("AgregarHorarioUnidad.fxml"));
        horarioUnidad.setController(agregarHorario);
        Scene sceneHorarioUnidad;
        try {
            sceneHorarioUnidad = new Scene(horarioUnidad.load());
            stageElegirUnidad.setScene(sceneHorarioUnidad);
        } catch (IOException ex) {
            Logger.getLogger(ProfesoresController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
